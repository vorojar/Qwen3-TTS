...
const i18n = {
  zh: {
    ...
    "project.newProjectPrompt": "输入项目名称",
    "project.chapter": "章",
    "project.newChapter": "添加章节",
    "project.newChapterPrompt": "输入章节名称",
    "project.defaultChapter": "第1章",
    "project.charConfig": "角色配置",
    "project.empty": "暂无项目",
    "project.deleteProject": "确定删除此项目及所有章节？",
    "project.deleteChapter": "确定删除此章节？",
    "project.renamePrompt": "输入新名称",
    "project.exportAll": "导出整本",
  ...
  en: {
    ...
    "btn.newProject": "New",
    "btn.editView": "Edit Text",
    "btn.resultView": "Results",
    "btn.regenAll": "Regenerate",
    ...
    "project.newProjectPrompt": "Enter project name",
    "project.chapter": "ch",
    "project.newChapter": "Add Chapter",
    "project.newChapterPrompt": "Enter chapter name",
    "project.defaultChapter": "Chapter 1",
    "project.charConfig": "Character Config",
    "project.empty": "No projects yet",
    "project.deleteProject": "Delete this project and all chapters?",
    "project.deleteChapter": "Delete this chapter?",
    "project.renamePrompt": "Enter new name",
